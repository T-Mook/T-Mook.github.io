...
const items: Array<{
    ...
    {
      title: '「나를 팀장으로 만드는 신입직원, 생성형 AI」, KT Enterprise',
      time: '2024.7',
      content: 'KT Enterprise <AICT 스토리(구 DX Story)> 기고문',
      color: 'dark grey',
      src: '/career/202407161328180087413.png',
      left: false,
      hideDot: true,
      btn: {
        bool: true,
        href:
          'https://enterprise.kt.com/bt/P_BT_TI_VW_001.do?bbsId=2615&bbsTP=A',
        text: '읽기 >',
        color: 'grey',
      },
    },
